/*
* The dining philosophers problem involves multiples threads needing
...
*
* To prevent deadlock from & deadly embrace" of waiting for neighboring
* forks, philosophers acquire lower numbers forks first. This breaks symmetry 
* and avoids circular waiting.
*
...
impl Philisopher {
    fn new(id: u32, name: &str, left_fork: Arc<Fork>, right_fork: Arc<Fork>) -> Philisopher {
        Philisopher {
            id, 
            name: name.to_string(),
            left_fork,
...
fn main() {
    println!("Dining Philosophers Problems: 1O Philosophers, 4 Forks...!!");
