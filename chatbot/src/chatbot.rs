...
pub async fn run_chat_loop(
    ...
    let mut conversation = String::from("The following is a conversation with an AI assistant. The assistant is helpful, creative, clever, and very frendly.\n");
